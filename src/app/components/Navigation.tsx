    ...
    >
      <div className="flex items-center justify-between p-4 md:p-6 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a href="/" className="text-[var(--foreground)] hover:opacity-80 transition-colors">Home</a>
          <a href="/about" className="text-[var(--foreground)] hover:opacity-80 transition-colors">About Us</a>
          <a href="/portfolio" className="text-[var(--foreground)] hover:opacity-80 transition-colors">Portfolio</a>
          <a href="/services" className="text-[var(--foreground)] hover:opacity-80 transition-colors">Services</a>
          <a href="/blog" className="text-[var(--foreground)] hover:opacity-80 transition-colors">Blog</a>
        </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-gray-400/30 bg-[var(--background)]/80 backdrop-blur-md">
          <div className="max-w-7xl mx-auto px-4 py-4 space-y-3">
            <a href="/" className="block text-[var(--foreground)] py-2">Home</a>
            <a href="/about" className="block text-[var(--foreground)] py-2">About Us</a>
            <a href="/portfolio" className="block text-[var(--foreground)] py-2">Portfolio</a>
            <a href="/services" className="block text-[var(--foreground)] py-2">Services</a>
            <a href="/blog" className="block text-[var(--foreground)] py-2">Blog</a>
            <Link
              href="/join"
